  ...
  public String[] getContext(Parse[] constituents, int index) {
    ...
    if (dict != null) {
      ...
      if (p1 != null) {
        ...
        b01 = dict.contains(new TokenList(bigram));
      }
    }
