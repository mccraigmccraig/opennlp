...
public class PosTagger extends POSTaggerME {
   ...
   * example: 
   *
   * <p>java opennlp.tools.lang.thai.PosTagger -test "Sr. Smith da el auto a sus hermano en Lunes."
   */
  public static void main(String[] args) throws IOException {
    ...
    if (tagdict != null) {
      tagger = new PosTagger(modelFile, new POSDictionary(tagdict,"UTF-8",true));
    }
    else {
