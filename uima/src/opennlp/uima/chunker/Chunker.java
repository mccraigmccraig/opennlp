 ...
 * @version $Revision: 1.1 $, $Date: 2005/12/02 17:25:30 $
 */
public final class Chunker extends Annotator_ImplBase 
        implements TextAnnotator
{
            ...
            AnnotatorConfigurationException
    {
        ...
        InputStream inModel = AnnotatorUtil.getResourceAsStream(mContext, 
        		modelName); 
        
        try
        {
            mChunker = new ChunkerME(new BinaryGISModelReader(
        ...
        catch (IOException e)
        {
            throw new AnnotatorInitializationException(
                    ...
                    new Object[]{"IOException during model reading: " + 
                    e.getMessage(), e});
        }
    }
    ...
    public void typeSystemInit(TypeSystem typeSystem) 
            ...
            AnnotatorConfigurationException
    {
        String chunkTypeName = 
          AnnotatorUtil.getRequiredParameter(mContext, 
            ...
            throws AnnotatorProcessException
    {
        ...
        AnnotationFS tokenAnnotations[] = 
        		new AnnotationFS[tokenAnnotationIndex.size()];
        ...
        {
            AnnotationFS tokenAnnotation = (AnnotationFS) 
                    tokenAnnotationIterator.next();
...
//          TODO: add configuration parameter for this
            ...
            FeatureStructure posFeature = 
                    tokenAnnotation.getFeatureValue(tokenFeature);
...
//          TODO: add configuration parameter for this
        ...
        for (int i = 0; i < tokens.length; i++)
        {
        	...
        	boolean isEndOfChunk = (result[i].equals("O") || 
        			isNewChunk) && result[i-1].startsWith("I-");
        	
        	if (isEndOfChunk)
        	{
        		int endOffset = tokenAnnotations[i - 1].getEnd();
        		
        		addChunkAnnotation(tcas, result[i - 1].substring(2), 
